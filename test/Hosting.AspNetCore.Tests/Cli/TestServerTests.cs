...
namespace Rocket.Surgery.Hosting.AspNetCore.Tests.Cli
{
    public class TestServerTests
    {
        ...
        public void CreateWithDelegate()
        {
            ...
            new WebHostWrapper(new WebHostBuilder()
        ...
        public void DoesNotCaptureStartupErrorsByDefault()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => new WebHostWrapper(builder.Build()));
        }
        ...
        public void CaptureStartupErrorsSettingPreserved()
        {
            ...
            // Does not throw
            new WebHostWrapper(builder.Build());
        }
        ...
        public void ApplicationServicesAvailableFromTestServer()
        {
            ...
            var builder = new WebHostBuilder()
                ...
                .UseServer(new CliServer());
            var server = new WebHostWrapper(builder.Build());
